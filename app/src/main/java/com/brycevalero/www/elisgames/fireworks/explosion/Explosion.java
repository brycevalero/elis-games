package com.brycevalero.www.elisgames.fireworks.explosion;
...
public class Explosion {
    ...
    public Explosion(int particleNr, int x, int y) {
        ...
        //create a solid color explosion
        this.color = Color.argb(255, Utilities.rndInt(0, 255), Utilities.rndInt(0, 255), Utilities.rndInt(0, 255));

        //ever firework has a 1 in six chance of being multicolor
        int multiColorChance = Utilities.rndInt(0, 5);

        for (int i = 0; i < this.particles.length; i++) {
            Particle p = new Particle(x, y);

            //the 4 is arbitrary
            if(multiColorChance == 4){
                this.color = Color.argb(255, Utilities.rndInt(0, 255), Utilities.rndInt(0, 255), Utilities.rndInt(0, 255));
            }
