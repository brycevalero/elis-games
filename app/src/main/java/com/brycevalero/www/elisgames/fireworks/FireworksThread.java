...
public class FireworksThread extends Thread{
    ...
    private static final String TAG = FireworksThread.class.getSimpleName();
    ...
    private FireworksView gamePanel;
    ...
    public FireworksThread(SurfaceHolder surfaceHolder, FireworksView gamePanel) {
        super();
